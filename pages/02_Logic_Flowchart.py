...
def render_logic_flowchart():
    st.header("Lógica de Negocio CRM: Flujo Verticalizado")
    
    # Definir el grafo en formato DOT con Layout Vertical Estricto
    dot = """
    digraph CRMLogic {
        rankdir=TB;
        splines=ortho; # Líneas ortogonales para limpieza
        nodesep=0.6;
        ranksep=0.8;
        ...
        DataParticipe -> Deposit [style=invis]; # Alineación
